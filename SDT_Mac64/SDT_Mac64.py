##############################################                                
# Sequence Demarcation Tool (Mac OSX 64 bits) #
...
if len(sys.argv)<=2: 
	print "Please specify the input fasta file and the alignment program properly e.g.: python SDT_Mac64.py test.fas muscle"
	sys.exit(0)
else:
...
MUSCLE_PATH=os.getcwd()+"/bin/muscle3.8.31_i86darwin64" 				# the path to muscle
