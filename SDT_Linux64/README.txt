SDT_Linux64 (Sequence Demarcation Tool - Linux 64 bits)
======================================================

SDT_Linux64 is a free version of SDT written in python, which runs on Linux 64 bits operating system.
...
2. Dowload the SDT_Linux64 from http://web.cbio.uct.ac.za/SDT

3. Extract the SDT_Linux64.tar file into the location you want to place the program.
   The folder contains:
      ...
      - SDT_linux64.py which the main script of the program.
      - test.fas a sample FASTA file to test the program.

4. Please change the mode of "muscle3.8.31_i86linux64", "clustalw2" and "neighbor" in the bin directory to "executable". 
