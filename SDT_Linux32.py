############################################                                
# Sequence Demarcation Tool (Linux 32 bits) #
...
if len(sys.argv)<=2: 
	print "Please specify the input fasta file and the alignment program properly e.g.: python SDT_Linux32.py test.fas muscle"
	sys.exit(0)
else:
